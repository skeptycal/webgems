      ...
      resources: [
        {
          ...
          desc:
            "Random JSON generator for your project - because debugging without data, does not make sense!",
          url: "https://www.json-generator.com"
        },
        {
          title: "Matomo",
          desc:
            "A free open source web analytics tool which can be compared to GA but actually gives a shit about privacy.",
        ...
        },
        {
          ...
          url:
            "https://dev.to/sauloco/10-free-but-professional-tools-for-your-dev-projects-2eeo"
        },
        {
          title: "headless cms",
        ...
        },
        {
          ...
          desc:
            "Create your own snippets for VSCode, Sublime or Atom using this generator. No need to format the snippet yourself",
        ...
        },
        {
          ...
          desc:
            'Take a any subreddit you like and append ".json" to consume it as an API (https://reddit.com/r/cats.json).',
        ...
        },
        {
          title: "JSFiddle",
          desc:
            "JSFiddle is for: Demos for docs, Bug reporting (test-case) for Github Issues, Live code collaboration, Code snippets hosting for free!",
        ...
        },
        {
          title: "Mailnator",
          desc:
            "The Mailinator Email System puts millions of inboxes right at your fingertips. It is an amazing Email Workflow Testing tool for your Software or Service.",
