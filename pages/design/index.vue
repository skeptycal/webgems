    ...
    return {
      resources: [
        ...
        },
        {
          ...
          desc:
            "Flatuicolorpicker is a project digging the Flat Color Picker which gives you the perfect colors for flat designs",
          url: "http://www.flatuicolorpicker.com"
        },
        {
          title: "awwwards",
          desc:
            "The awards for design, creativity and innovation on the Internet. Get your inspiration here or even submit your own website!",
        ...
        },
        {
          title: "ShapeFactory",
          desc:
            "Simple design tools for everyone. Simply create a logo, pigment/color scheme, gradient or duetone style.",
        ...
        },
        {
          title: "Hyperpixel.io",
          desc:
            "Discover the latest designs for your own inspiration from our curated list of landing pages.",
          url: "https://hyperpixel.io/"
        },
        {
          title: "sharpen.design",
          desc:
            "Sharpen is where designers hone their craft - randomly generated design challenges.",
