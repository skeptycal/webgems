    ...
    return {
      resources: [
        ...
        },
        {
          ...
          desc:
            "The PHP manual is documenting the whole spec while giving examples for each property.",
        ...
        },
        {
          ...
          desc:
            "3v4l.org (leetspeak for eval) is an online shell that allows you to run your code on my server. I compiled more than 200 different PHP versions (every version released since 4.3.0) plus HHVM for you to use.",
          url: "https://3v4l.org/"
        },
        {
        ...
        },
        {
          ...
          desc:
            "Object Calisthenics are programming exercises, formalized as a set of 9 rules invented by Jeff Bay in his book The ThoughtWorks Anthology. The word Object is related to Object Oriented Programming. The word Calisthenics is derived from greek, and means exercises under the context of gymnastics.",
          url: "https://williamdurand.fr/2013/06/03/object-calisthenics/"
        },
        {
          title: "Your code sucks, let's fix it",
          desc:
            "134 Slides to help fix your code. Performance and testing are just one aspect of code, to really be successful your code needs to be readable, maintainable and generally easier to comprehend and work with.",
          url:
