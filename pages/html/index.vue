      ...
      resources: [
        {
          title: "HTML ELEMENTS",
          desc:
            "All the HTML elemens you can use. There is more than just a div :)",
          url: "https://developer.mozilla.org/de/docs/Web/HTML/Element"
        },
        {
          title: "The web accessibility basics",
          desc:
            "The absolute web accessibility basics every web developer should know about.",
          url:
        ...
        },
        {
          ...
          desc:
            "A curated list of awesome Canvas examples, related articles and posts.",
        ...
        },
        {
          ...
          desc:
            "This tool is checking your markup if it complies with the specification and will show you possible errors.",
