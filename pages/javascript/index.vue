    ...
    return {
      resources: [
        ...
        },
        {
          title: "YDKJS",
          desc:
            "This is a free series of books diving deep into the core mechanisms of the JavaScript language. The first edition of the series is now complete.",
          url: "https://github.com/getify/You-Dont-Know-JS"
        },
        {
          title: "Eloquent Javascript 3rd Edition",
          desc:
            "This is a book about javascript, programming, and the wonders of the digital. You can read it online or get a paperback copy of it.",
